...
export default function Interested(){
    ...
    return  <>
                <section className="flex flex-col lg:w-[680px] lg:mx-[50px]">
                    <h2 className="text-3xl font-bold dark  pb-6">Lista de interesados</h2>
                    <ul className="space-y-3">
                        {
                            interested.length == 0 ?
                            <p>No hay socios registrados</p> :
                            interested.map( ({_id,nombreEntidad,provincia,tipoSocio}) => { return <li key={_id} className="p-3 flex flex-col items-start sm:items-center sm:flex-row justify-between border border-color rounded-[4px] mb-4 w-full bg-[#D3CAE6]"> 
                                 <div>
