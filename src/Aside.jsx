    ...
    return <>
              {/* Sidebar - 20% ancho */}
                <aside className={`
                    ...
                    md:static md:translate-x-0 md:w-[30%] md:flex
                ...
                `}>
                    ...
                    }} className="md:hidden flex gap-2 justify-center items-center bg-[#31234E] light border border-color text-black px-4 mx-6 py-2 rounded hover:bg-[#D14D41]">Cerrar sesión 
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
